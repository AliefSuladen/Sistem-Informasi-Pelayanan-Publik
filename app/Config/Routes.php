...
$routes->group('', ['filter' => 'role:Masyarakat'], function ($routes) {
...
$routes->group('', ['filter' => 'role:Admin Desa'], function ($routes) {
...
$routes->group('', ['filter' => 'role:Kepala Desa'], function ($routes) {
    ...
    $routes->get('cek-data-warga', 'Desa::data_warga');
    $routes->post('kades-hapus-user/(:num)', 'Desa::delete/$1');
});

$routes->group('', ['filter' => 'role:Admin Kecamatan'], function ($routes) {
    ...
    $routes->get('log-aktivitas', 'Kecamatan::log');
});
