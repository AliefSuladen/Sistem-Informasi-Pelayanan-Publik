  ...
  <div class="wrapper">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            ?>
              ...
              <li class="nav-item has-treeview <?= in_array($current_url, ['kecamatan-data-desa', 'kecamatan-data-admin', 'data-berita', 'kecamatan-jenis-surat', 'kecamatan-laporan', 'log-aktivitas']) ? 'menu-open' : '' ?>">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="<?= base_url('data-berita') ?>" class="nav-link <?= $current_url == 'data-berita' ? 'active' : '' ?>">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Data Berita</p>
                    </a>
                  </li>
            ...
            <?php if (session()->get('role') == 'Kepala Desa'):
            ?>
              <li class="nav-item">
            ...
            <?php if (session()->get('role') == 'Admin Desa'):
            ?>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="<?= base_url('data-berita') ?>" class="nav-link">
                  <i class="nav-icon fas fa-users"></i>
                  <p>Berita</p>
                </a>
              </li>
    ...
    <footer class="main-footer">
      ...
      <div class="float-right d-none d-sm-inline">
        <span class="text-muted">Kecamatan Lais, Kabupaten Musi Banyuasin</span>
      </div>
      <strong></strong>
      <small> &copy; <?= date('Y') ?> e-LAIS | Kec. Lais, Musi Banyuasin</small>
    </footer>
  </div>
  <!-- ./wrapper -->
