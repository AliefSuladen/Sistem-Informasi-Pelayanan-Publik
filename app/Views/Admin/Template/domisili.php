...
<body>
    ...
    <!-- Judul Surat -->
    <div class="center">
        <h3 class="underline">SURAT KETERANGAN DOMISILI</h3>
        <p>Nomor: <?= $permohonan['nomor_surat'] ?></p>
    </div>

    <!-- Isi Surat -->
    <p class="isi">
        Yang bertanda tangan di bawah ini, Kepala Desa Teluk Kijing III, Kecamatan Lais, Kabupaten Musi Banyuasin, menerangkan bahwa:
    </p>
    ...
    <p class="isi">
        Orang yang namanya diatas memang benar penduduk Desa Teluk Kijing III Kecamatan Lais Kabupaten Musi Banyuasin dan bertempat tinggal/domisili seperti pada alamat tersebut.
    </p>
