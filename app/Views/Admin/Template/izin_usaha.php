...
$nomorSurat = model('Modelpermohonan')->getNomorSuratIzinUsaha();
...
<body>
    ...
    <div class="center">
        <h3><u>SURAT IZIN USAHA</u></h3>
        <p>Nomor: <?= $nomorSurat ?></p>
    </div>

    <p>Yang bertanda tangan di bawah ini, Camat Lais, Kabupaten Musi Banyuasin, memberikan izin usaha kepada:</p>
    ...
    <p class="mt-2">Untuk mendirikan dan menjalankan usaha dengan rincian sebagai berikut:</p>
    ...
    <p class="mt-2">Surat Izin Usaha ini berlaku selama usaha dijalankan dan tidak disalahgunakan untuk kegiatan lain yang bertentangan dengan hukum.</p>

    <p>Demikian surat izin ini dibuat agar dapat dipergunakan sebagaimana mestinya.</p>
